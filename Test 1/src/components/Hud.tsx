...
export function Hud() {
  ...
  return (
    <aside
      ...
      className="pointer-events-none fixed bottom-5 left-[clamp(1rem,4vw,4.5rem)] z-[55] hidden w-56 border border-line/60 bg-ink/70 p-3 backdrop-blur-md lg:block"
    >
